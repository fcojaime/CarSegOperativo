<?php
//Include Common Files @1-8F9356B5
define("RelativePath", "..");
...
//Class_Initialize Event @2-EB65B72D
    function clsRecordNewRecord1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            list($this->ListBox1->BoundColumn, $this->ListBox1->TextColumn, $this->ListBox1->DBFormat) = array("id_layout", "nom_layout", "");
            $this->ListBox1->DataSource->SQL = "SELECT id_layout, nombre_layout+' ('+tipo_arch+')' as nom_layout, tipo_arch\n" .
            "FROM layouts  ";
            $this->ListBox1->DataSource->Order = "";
            $this->Button_Cancel = new clsButton("Button_Cancel", $Method, $this);
            $this->archivo_excel = new clsFileUpload("archivo_excel", "archivo_excel", "./temp_xls/", "./", "xls", "", 100000, $this);
            $this->archivo_excel->Required = true;
        }
    }
//End Class_Initialize Event

//Validate Method @2-61262A7A
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
//Execute Components @1-87F310B7
$MasterPage->Operations();
$NewRecord1->Operation();
//End Execute Components

//Go to destination page @1-D4A3F806
if($Redirect)
{
