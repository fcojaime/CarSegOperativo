<?php
//Include Common Files @1-D1688AA7
define("RelativePath", "..");
define("PathToCurrentPage", "/rep_historico/");
...
//Include Page implementation @56-F9FF4744
include_once(RelativePath . "/rep_historico/Header.php");
